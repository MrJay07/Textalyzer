...
export default function Footer() {
  ...
  return (
    ...
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <Link to="/" onClick={handleUpSc} class="hover:underline">Textalyzer</Link>. All Rights Reserved.
    </span>
